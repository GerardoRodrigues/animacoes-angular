...
import { buttonCheckTrigger, buttonCriarTrigger, filterTrigger, formButtonTrigger, highlightedStatedTrigger, listTrigger, shakeTrigger, shownStateTrigger } from '../animations';
...
@Component({
  ...
  animations: [highlightedStatedTrigger, shownStateTrigger, buttonCheckTrigger, buttonCriarTrigger, filterTrigger, formButtonTrigger, shakeTrigger, listTrigger]
})
export class ListaTarefasComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.service.listar();
    this.tarefaSubscription = this.service.tarefas$.subscribe(tarefas => {
